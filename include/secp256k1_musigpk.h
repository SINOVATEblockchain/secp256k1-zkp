...
} secp256k1_musigpk_session_signer_data;
...
} secp256k1_musigpk_partial_signature;
 ...
 */
SECP256K1_API int secp256k1_musigpk_pubkey_combine(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API int secp256k1_musigpk_session_initialize(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API int secp256k1_musigpk_session_initialize_sin(
    const secp256k1_context* ctx,
    secp256k1_musig_session *session,
    secp256k1_musig_session_signer_data *signers,
    unsigned char *nonce_commitment32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_musigpk_session_get_public_nonce(
    const secp256k1_context* ctx,
    secp256k1_musig_session *session,
    secp256k1_musig_session_signer_data *signers,
    secp256k1_pubkey *nonce,
 ...
 *                    2^32 - 1.
 */
SECP256K1_API int secp256k1_musigpk_session_initialize_verifier(
    const secp256k1_context* ctx,
    secp256k1_musig_session *session,
    secp256k1_musig_session_signer_data *signers,
    const unsigned char *msg32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_musigpk_set_nonce(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API int secp256k1_musigpk_session_combine_nonces(
    const secp256k1_context* ctx,
    secp256k1_musig_session *session,
 ...
 */
SECP256K1_API int secp256k1_musigpk_partial_signature_serialize(
    const secp256k1_context* ctx,
    unsigned char *out32,
 ...
 */
SECP256K1_API int secp256k1_musigpk_partial_signature_parse(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API int secp256k1_musigpk_partial_sign(
    const secp256k1_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_musigpk_partial_sig_verify(
    const secp256k1_context* ctx,
    const secp256k1_musig_session *session,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_musigpk_partial_sig_combine(
    const secp256k1_context* ctx,
    const secp256k1_musig_session *session,
 ...
 */
SECP256K1_API int secp256k1_musigpk_partial_sig_adapt(
    const secp256k1_context* ctx,
 ...
 *   nonce_is_negated: the `nonce_is_negated` output of `musig_session_combine_nonces`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_musigpk_extract_secret_adaptor(
    const secp256k1_context* ctx,
